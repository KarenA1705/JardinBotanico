...
class estados_MO
{
  ...
  function agregarestados($codigo, $nombre)
  {
    ...
    $sql = "insert into estado_conservacion (cod_estado, nombre) values ('$codigo','$nombre' )";
  ...
  function actualizarestados($codigo, $nombre,$codigo_org)
  {
    ...
    $sql = "update estado_conservacion set cod_estado='$codigo', nombre='$nombre'   where cod_estado='$codigo_org'";
